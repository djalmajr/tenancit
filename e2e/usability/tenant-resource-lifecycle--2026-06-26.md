...
- **Ambiente:** stack Tenancit atual (Vite :5180 + API :8087 + Postgres :5433). Seed: definition `dbconn-e2e` (DB Conn E2E) com campos `host` (obrigatório) e `password` (obrigatório, segredo); tenant `acme-e2e`.
