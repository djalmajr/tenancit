...
design_refs:
  auth: "planning/konvario/proto/components/app-shell.js"
...
4. (`auth`) Preencher **Token** com `konvario_admin_dev` e clicar em **Entrar** → a visão geral carrega com KPIs reais e sidebar visível.
