  ...
  return <Tabs className="gap-4" defaultValue="overview">
    ...
    <TabsContent className="flex flex-col gap-6" value="overview">
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        <StatCard hint={t("audit.partitionHealthHint")} icon={<ShieldCheck className="size-4" />} label={t("audit.partitionHealth")} value={healthQuery.data?.future_through ? new Date(healthQuery.data.future_through).toLocaleDateString() : "—"} />
